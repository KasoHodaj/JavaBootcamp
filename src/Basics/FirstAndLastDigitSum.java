...
public class FirstAndLastDigitSum {
    ...
    public static void main(String[] args) {
        // Test cases
        System.out.println(sumFirstAndLastDigit(121));   // Expected: 2
        System.out.println(sumFirstAndLastDigit(-121));  // Expected: -1
        System.out.println(sumFirstAndLastDigit(12329)); // Expected: 10
        System.out.println(sumFirstAndLastDigit(123));   // Expected: 4
    }
}